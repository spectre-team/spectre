...
namespace Spectre.Algorithms.Tests.Methods
{
    ...
    public class PreprocessingTests
    {
        ...
        public void RemoveBaseline()
        {
            ...
            double[,] data =
            {
                {1.1, 1.2, 0.97, 1.07, 1.02, 5, 1.2, 1.5, 1.6, 1.2},
                {1.1, 1.2, 0.97, 1.07, 1.02, 5, 1.2, 1.5, 1.6, 1.2},
                {1.1, 1.2, 0.97, 1.07, 1.02, 5, 1.2, 1.5, 1.6, 1.2},
                {1.1, 1.2, 0.97, 1.07, 1.02, 5, 1.2, 1.5, 1.6, 1.2}
            };
            ...
            var result = _preprocessing.RemoveBaseline(dataset);
        ...
        public void PeakAlignmentFFT()
        {
            ...
            var result = _preprocessing.AlignPeaksFft(dataset);
        ...
        public void TicNorm()
        {
            ...
            var result = _preprocessing.NormalizeByTic(dataset);
